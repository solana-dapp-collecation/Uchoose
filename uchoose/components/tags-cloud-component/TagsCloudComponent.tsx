...
const TagsCloudComponent = (props: any) => (
    <>
        ...
        {/*<div className={tagsCloudStyles.appOuter}>*/}
        {/*    <div className={tagsCloudStyles.appInner}>*/}
        {/*        <h1>react-tag-cloud demo</h1>*/}
        {/*        <TagCloud*/}
        {/*            className={tagsCloudStyles.tagCloud}*/}
        {/*            style={{*/}
        ...
        {/*            <div className={tagsCloudStyles.tagItemWrapper}>*/}
        {/*                <div>*/}
        {/*                    Hover Me Please!*/}
        {/*                </div>*/}

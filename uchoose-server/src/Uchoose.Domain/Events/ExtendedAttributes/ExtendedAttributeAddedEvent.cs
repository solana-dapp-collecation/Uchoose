// ------------------------------------------------------------------------------------------------------
// <copyright file="ExtendedAttributeAddedEvent.cs" company="Life Loop">
...
{
    /// <summary>
    /// Событие добавления расширенного атрибута сущности.
    /// </summary>
    /// <typeparam name="TEntityId">Тип идентификатора сущности.</typeparam>
    /// <typeparam name="TEntity">Тип сущности.</typeparam>
    public class ExtendedAttributeAddedEvent<TEntityId, TEntity> :
        DomainEvent,
        IHasIsActive
            where TEntity : class, IEntity<TEntityId>
    {
        /// <summary>
        /// Инициализирует экземпляр <see cref="ExtendedAttributeAddedEvent{TEntityId, TEntity}"/>.
        /// </summary>
        ...
        public ExtendedAttributeAddedEvent(

// ------------------------------------------------------------------------------------------------------
// <copyright file="AuditableDomainEntity.cs" company="Life Loop">
...
{
    /// <summary>
    /// Отслеживаемая доменная сущность.
    /// </summary>
    ...
    /// <inheritdoc/>
    public abstract class AuditableDomainEntity : AuditableDomainEntity<Guid>
    {
        /// <inheritdoc/>

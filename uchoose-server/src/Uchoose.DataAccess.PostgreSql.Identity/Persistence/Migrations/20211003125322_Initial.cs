...
namespace Uchoose.DataAccess.PostgreSql.Identity.Persistence.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UchooseRoleExtendedAttribute",
                schema: "Identity",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UchooseRoleExtendedAttribute", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UchooseRoleExtendedAttribute_AspNetRoles_EntityId",
                        column: x => x.EntityId,
                        principalSchema: "Identity",
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "UchooseUserExtendedAttribute",
                schema: "Identity",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UchooseUserExtendedAttribute", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UchooseUserExtendedAttribute_AspNetUsers_EntityId",
                        column: x => x.EntityId,
                        principalSchema: "Identity",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UchooseRoleExtendedAttribute_EntityId",
                schema: "Identity",
                table: "UchooseRoleExtendedAttribute",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_UchooseUserExtendedAttribute_EntityId",
                schema: "Identity",
                table: "UchooseUserExtendedAttribute",
                column: "EntityId");
        }

// ------------------------------------------------------------------------------------------------------
// <copyright file="UchooseRoleClaim.cs" company="Life Loop">
...
namespace Uchoose.Domain.Identity.Entities
{
    ...
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="UchooseRoleClaim"/>.
        /// </summary>
        /// <remarks>
        /// Свойство Id инициализируется новым значением GUID.
        /// </remarks>
        public UchooseRoleClaim()
        {
        }
        ...
        public UchooseRoleClaim(string roleClaimDescription = null, string roleClaimGroup = null)
        {
        ...
        /// <summary>
        /// Роль пользователя, которой принадлежит разрешение.
        /// </summary>
        public virtual UchooseRole Role { get; set; }

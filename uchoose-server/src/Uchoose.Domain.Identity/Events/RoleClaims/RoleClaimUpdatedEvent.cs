// ------------------------------------------------------------------------------------------------------
// <copyright file="RoleClaimUpdatedEvent.cs" company="Life Loop">
...
{
    /// <summary>
    /// Событие обновления разрешения роли пользователя.
    /// </summary>
    public class RoleClaimUpdatedEvent :
        DomainEvent<UchooseRoleClaim>
    {
        ...
        public RoleClaimUpdatedEvent(UchooseRoleClaim roleClaim, string eventDescription)
            : base(
                roleClaim.RoleId,
                eventDescription,
                null,

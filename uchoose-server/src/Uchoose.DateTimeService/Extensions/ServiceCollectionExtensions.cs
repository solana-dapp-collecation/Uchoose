...
namespace Uchoose.DateTimeService.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Добавить сервис для работы с датой и временем.
        /// </summary>
        ...
        {
            return services
                .AddScopedInfrastructureService<IDateTimeService, DateTimeService>();
        }
    }
}
// ------------------------------------------------------------------------------------------------------
// <copyright file="UpdateNftImageLayerTypeCommand.cs" company="Life Loop">
...
{
    /// <summary>
    /// Команда для обновления типа слоя изображения NFT.
    /// </summary>
    [UseReverseMap(typeof(Domain.Marketplace.Entities.NftImageLayerType))]
    public class UpdateNftImageLayerTypeCommand :
        IRequest<Result<Guid>>,
        IMapFromTo<Domain.Marketplace.Entities.NftImageLayerType, UpdateNftImageLayerTypeCommand>,
        ILoggable,
        IHasName,

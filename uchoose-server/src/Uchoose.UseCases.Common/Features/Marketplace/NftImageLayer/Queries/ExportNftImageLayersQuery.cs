// ------------------------------------------------------------------------------------------------------
// <copyright file="ExportNftImageLayersQuery.cs" company="Life Loop">
...
{
    /// <summary>
    /// Запрос на экспорт слоёв изображений NFT с пагинацеией.
    /// </summary>
    public class ExportNftImageLayersQuery :
        IRequest<Result<string>>,
        IMapFromTo<NftImageLayersExportPaginationFilter, ExportNftImageLayersQuery>,
        IMapFromTo<ExportRequest<Guid, Domain.Marketplace.Entities.NftImageLayer>, ExportNftImageLayersQuery>,
        IPaginated,
        ILoggable,
        ISearchableRequest,
        IHasIsActive<bool?>,
        ...
        IHasExportableProperties
    {
        ...
        /// <inheritdoc/>
        void IMapFromTo<NftImageLayersExportPaginationFilter, ExportNftImageLayersQuery>.Mapping(Profile profile, bool useReverseMap)
        {
            profile.CreateMap<NftImageLayersExportPaginationFilter, ExportNftImageLayersQuery>()
                .ForMember(dest => dest.OrderBy, opt => opt.ConvertUsing<string>(new OrderByConverter()));
        }

        /// <inheritdoc/>
        void IMapFromTo<ExportRequest<Guid, Domain.Marketplace.Entities.NftImageLayer>, ExportNftImageLayersQuery>.Mapping(Profile profile, bool useReverseMap)
        {
            // меняем порядок сопоставления
            profile.CreateMap<ExportNftImageLayersQuery, ExportRequest<Guid, Domain.Marketplace.Entities.NftImageLayer>>();
        }
    }
}
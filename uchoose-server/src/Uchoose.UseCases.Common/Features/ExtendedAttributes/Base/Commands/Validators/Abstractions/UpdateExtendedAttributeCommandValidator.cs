// ------------------------------------------------------------------------------------------------------
// <copyright file="UpdateExtendedAttributeCommandValidator.cs" company="Life Loop">
...
{
    /// <summary>
    /// Валидатор команды для обновления расширенного атрибута сущности.
    /// </summary>
    ...
    {
        /// <summary>
        /// Инициализирует экземпляр <see cref="UpdateExtendedAttributeCommandValidator{TEntityId, TEntity}"/>.
        /// </summary>

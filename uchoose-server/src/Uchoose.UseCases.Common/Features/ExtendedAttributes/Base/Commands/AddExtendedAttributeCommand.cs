// ------------------------------------------------------------------------------------------------------
// <copyright file="AddExtendedAttributeCommand.cs" company="Life Loop">
...
{
    /// <summary>
    /// Команда для добавления расширенного атрибута сущности.
    /// </summary>
    /// <typeparam name="TEntityId">Тип идентификатора сущности.</typeparam>
    /// <typeparam name="TEntity">Тип сущности.</typeparam>
    // ReSharper disable once UnusedTypeParameter
    public class AddExtendedAttributeCommand<TEntityId, TEntity> :
